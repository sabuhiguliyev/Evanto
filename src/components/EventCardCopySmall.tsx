...
const EventCard: React.FC<EventCardProps> = ({
    ...
    return (
        <Card className='h-40 w-40 overflow-hidden rounded-xl bg-gray-50 p-2'>
            <Box className='w-38 relative mb-1'>
                <CardMedia component='img' image={imageUrl} alt={title} className='object-cover' />
                <Chip label='Event' className='absolute left-2 top-2 h-4 bg-blue-500 text-[7px] text-white' />
            </Box>
