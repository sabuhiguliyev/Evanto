  ...
  return (
    <>
      ...
      <Container className={`justify-start no-scrollbar ${isDarkMode ? 'bg-[#1C2039]' : 'bg-white'}`}>
        ...
        {/* BottomAppBar with Navigation Items */}
        <Box className='flex justify-center mt-8 relative'>
          <svg width="405" height="119" viewBox="0 0 405 119" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              <filter id="filter0_d_1576_43" x="0" y="0.368896" width="405" height="118.631" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                ...
                <feBlend mode="normal" in2="SourceGraphic" in2="effect1_dropShadow_1576_43" result="shape"/>
              </filter>
            </defs>
          </svg>
            ...
            <Box className='flex flex-col items-center'>
              ...
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M3 9L12 2L21 9V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V9Z" stroke="#5D9BFC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M9 22V12H15V22" stroke="#5D9BFC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </Box>
              <Typography variant="caption" className={`font-medium text-xs ${isDarkMode ? 'text-[#5D9BFC]' : 'text-[#5D9BFC]'}`}>
                Home
              </Typography>
            </Box>
